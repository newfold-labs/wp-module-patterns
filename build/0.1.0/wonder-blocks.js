...
const DesignItem = _ref => {
   ...
   * @return {boolean}
   */
  const shouldSetBlankTemplate = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useCallback)(() => {
    return (item === null || item === void 0 ? void 0 : item.type) === 'templates' && selectedTemplateSlug !== (0,_wordpress_url__WEBPACK_IMPORTED_MODULE_10__.cleanForSlug)(_constants__WEBPACK_IMPORTED_MODULE_11__.WONDER_BLOCKS_BLANK_TEMPLATE_SLUG);
  }, [item === null || item === void 0 ? void 0 : item.type, selectedTemplateSlug]);
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    let isFav = false;
...
const ToolbarButton = () => {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToolbarButton, {
    ...
    className: classnames__WEBPACK_IMPORTED_MODULE_1___default()('nfd-wba-ml-2 nfd-wba-flex !nfd-wba-h-9 nfd-wba-shrink-0 nfd-wba-gap-1 nfd-wba-bg-brand nfd-wba-text-white hover:nfd-wba-bg-brand-darker hover:nfd-wba-text-white focus-visible:nfd-wba-text-white active:nfd-wba-bg-brand-darker-10 active:!nfd-wba-text-white', isModalOpen && '!nfd-wba-bg-dark nfd-wba-text-white'),
...
const usePostTemplates = () => {
  ...
  } = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_2__.useDispatch)(_wordpress_edit_post__WEBPACK_IMPORTED_MODULE_3__.store);
  const {
    templates
  } = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_2__.useSelect)(select => ({
    templates: select(_wordpress_core_data__WEBPACK_IMPORTED_MODULE_1__.store).getEntityRecords('postType', 'wp_template', {
      status: 'publish',
      per_page: -1
    })
  }));
...
"use strict";
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"wonder-blocks/library","title":"Patterns & Templates","description":"Add patterns and page templates tailored for your site.","keywords":["template","patterns","blocks"],"textdomain":"nfd-wonder-blocks","attributes":{"preview":{"type":"string"},"category":{"type":"string"}}}');
