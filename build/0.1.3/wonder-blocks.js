...
/* harmony import */ var _ContentTitle__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./ContentTitle */ "./src/components/Modal/Content/ContentTitle.jsx");
/* harmony import */ var _DesignList_DesignList__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./DesignList/DesignList */ "./src/components/Modal/Content/DesignList/DesignList.jsx");
/* harmony import */ var _DesignList_Error__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./DesignList/Error */ "./src/components/Modal/Content/DesignList/Error.jsx");
/* harmony import */ var _DesignList_NoResults__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./DesignList/NoResults */ "./src/components/Modal/Content/DesignList/NoResults.jsx");
...
const Content = () => {
  ...
  const {
    ...
    isSidebarLoading: select(_store__WEBPACK_IMPORTED_MODULE_3__.store).isSidebarLoading(),
    isContentLoading: select(_store__WEBPACK_IMPORTED_MODULE_3__.store).isContentLoading(),
    keywordsFilter: select(_store__WEBPACK_IMPORTED_MODULE_3__.store).getKeywordsFilter()
  }));
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  }, isSidebarLoading && !isError && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_LoadingSpinner__WEBPACK_IMPORTED_MODULE_8__["default"], null), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "nfd-wba-inset-0 nfd-wba-flex nfd-wba-grow nfd-wba-flex-col nfd-wba-px-4 nfd-wba-py-8 sm:nfd-wba-px-6"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_ContentTitle__WEBPACK_IMPORTED_MODULE_4__["default"], {
    activeTab: activeTab,
    ...
    ref: loadMoreRef
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Spinner__WEBPACK_IMPORTED_MODULE_10__["default"], {
    size: 40
  }))))));
};
...
/* harmony import */ var _hooks_useCategories__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../hooks/useCategories */ "./src/hooks/useCategories.js");
...
const ContentTitle = _ref => {
  ...
  const {
    data,
    error
  } = (0,_hooks_useCategories__WEBPACK_IMPORTED_MODULE_2__["default"])(activeTab);
  const activeCategory = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => data === null || data === void 0 ? void 0 : data.find(cat => cat.title === currentCategory), [data, currentCategory]);
  if (error || !data) {
    return null;
  }
  if (!(activeCategory !== null && activeCategory !== void 0 && activeCategory.label) && !title && currentCategory !== 'favorites') {
    return null;
  }
  ...
  (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Results for %s', 'nfd-wonder-blocks'), title), !title && (activeCategory === null || activeCategory === void 0 ? void 0 : activeCategory.label));
};
...
/* harmony import */ var _helpers_analytics__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../../../helpers/analytics */ "./src/helpers/analytics.js");
/* harmony import */ var _helpers_blockInserter__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../../../helpers/blockInserter */ "./src/helpers/blockInserter.js");
...
/* harmony import */ var _Icons__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../../Icons */ "./src/components/Icons/index.js");
...
const DesignItem = ({
  ...
  const {
    data,
    mutate
  } = (0,_hooks_usePatterns__WEBPACK_IMPORTED_MODULE_14__["default"])({
    onlyFavorites: true
  });
  const {
    data: allFavs,
  ...
  const trackInsertEvents = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useCallback)(() => {
    if (activeTab === 'patterns') {
      (0,_helpers_analytics__WEBPACK_IMPORTED_MODULE_11__.trackHiiveEvent)('pattern_inserted', {
        label_key: 'pattern_slug',
        pattern_id: item.id,
        pattern_slug: item.slug
      });
    } else if (activeTab === 'templates') {
      (0,_helpers_analytics__WEBPACK_IMPORTED_MODULE_11__.trackHiiveEvent)('template_inserted', {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    icon: (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_icons__WEBPACK_IMPORTED_MODULE_17__["default"], {
      ...
      fill: "currentColor",
      size: 24,
      icon: isFavorite ? _Icons__WEBPACK_IMPORTED_MODULE_16__.heart : _Icons__WEBPACK_IMPORTED_MODULE_16__.heartEmpty
    })
    ...
    icon: (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_icons__WEBPACK_IMPORTED_MODULE_17__["default"], {
      ...
      width: 32,
      height: 32,
      icon: _Icons__WEBPACK_IMPORTED_MODULE_16__.trash
    })
    ...
    icon: (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_icons__WEBPACK_IMPORTED_MODULE_17__["default"], {
      ...
      className: "nfd-wba-shrink-0",
      size: 24,
      icon: _Icons__WEBPACK_IMPORTED_MODULE_16__.plus
    })
  }))));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.memo)(DesignItem));
...
const DesignList = _ref => {
  ...
  }, data === null || data === void 0 ? void 0 : data.map((pattern, index) => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_DesignItem__WEBPACK_IMPORTED_MODULE_2__["default"], {
    key: `${pattern.key}-${index}`,
    item: pattern
  }))));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.memo)(DesignList));
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.memo)(Skeleton));
...
/* harmony import */ var _wordpress_data__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @wordpress/data */ "@wordpress/data");
/* harmony import */ var _wordpress_data__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_wordpress_data__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _helpers_analytics__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../helpers/analytics */ "./src/helpers/analytics.js");
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../store */ "./src/store/index.js");
...
const Modal = () => {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    if (searchParams.has('wonder-blocks-library')) {
      timer = setTimeout(() => {
        ...
        (0,_helpers_analytics__WEBPACK_IMPORTED_MODULE_3__.trackHiiveEvent)('modal_open', {
          label_key: 'trigger',
          trigger: 'url'
        });
        setIsModalOpen(true);
  ...
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Sidebar_Sidebar__WEBPACK_IMPORTED_MODULE_7__["default"], null), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Content_Header_Header__WEBPACK_IMPORTED_MODULE_6__["default"], null), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Content_Content__WEBPACK_IMPORTED_MODULE_5__["default"], null)));
};
...
/* harmony import */ var _hooks_usePatterns__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../hooks/usePatterns */ "./src/hooks/usePatterns.js");
...
const Categories = _ref => {
  ...
  const {
    data: allFavs
  } = (0,_hooks_usePatterns__WEBPACK_IMPORTED_MODULE_5__["default"])({
    onlyFavorites: true,
    perPage: -1
  });
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.memo)(Categories));
...
const ListElement = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.forwardRef)((_ref, ref) => {
  ...
  const categoryCount = (_category$count = category === null || category === void 0 ? void 0 : category.count) !== null && _category$count !== void 0 ? _category$count : null; // 0 is a valid count.
  ...
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("span", null, category === null || category === void 0 ? void 0 : category.label), icon && icon), categoryCount !== null && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("span", {
    className: classnames__WEBPACK_IMPORTED_MODULE_2___default()('nfd-wba-px-[14px] nfd-wba-py-1 nfd-wba-text-sm nfd-wba-text-dark-lighter', (category === null || category === void 0 ? void 0 : category.title) !== 'favorites' && 'nfd-wba-rounded-full nfd-wba-bg-grey')
  }, categoryCount)));
});
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.memo)(Sidebar));
