...
const withInspectorControls = (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_3__.createHigherOrderComponent)(BlockEdit => {
  return props => {
    ...
    const customStyles = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => [{
      name: '',
      label: 'Default',
      isDefault: true
    }, {
...
function addSaveProps(saveElementProps, blockType, attributes) {
  ...
  const classes = attributes?.nfdGroupDivider ? [attributes.nfdGroupDivider] : [];
