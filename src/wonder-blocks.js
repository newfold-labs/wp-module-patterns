...
import WonderBlocksEditorPlugin from "./components/Sidebar/plugin";

const ProductIcon = (<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
...
/**
 * Register the WonderBlocks editor plugin.
 */
const editorSidebar = () => {
	registerPlugin("wonder-blocks-editor", {
		render: WonderBlocksEditorPlugin,
		icon: ProductIcon,
	});
}
