	...
	theme: {
		extend: {
			colors: {
				...
				brand: {
					DEFAULT: "rgb(var(--nfd-wba-color-brand-rgb) / <alpha-value>)",
					darker: "rgb(var(--nfd-wba-color-brand-darker-rgb) / <alpha-value>)",
					"darker-10": "rgb(var(--nfd-wba-color-brand-darker-10-rgb) / <alpha-value>)",
				},
				grey: {
					DEFAULT: "rgb(var(--nfd-wba-color-grey-rgb) / <alpha-value>)",
					darker: "rgb(var(--nfd-wba-color-grey-darker-rgb) / <alpha-value>)",
				},
				dark: {
					DEFAULT: "rgb(var(--nfd-wba-color-dark-rgb) / <alpha-value>)",
					lighter: "rgb(var(--nfd-wba-color-dark-lighter-rgb) / <alpha-value>)",
				},
			},
			transitionDuration: {
